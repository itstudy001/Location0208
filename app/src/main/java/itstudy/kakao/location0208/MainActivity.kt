package itstudy.kakao.location0208
...
class MainActivity : AppCompatActivity(), AutoPermissionsListener {
    ...
    inner class GPSListener : LocationListener {
        ...
        override fun onLocationChanged(location: Location) {
            ...
            textView!!.text = "내 위치: 위도-${latitude} 경도-${longitude}" +
                    " 고도:${altitude} "
        }
    ...
    fun startLocationService(){
        ...
        if(location != null) {
            ...
            val longitude = location.longitude
            val altitude = location.altitude
            textView!!.text = "현재 위치: 위도-${latitude} 경도-${longitude}" +
                    " 고도:${altitude} "
        ...
        Toast.makeText(this, "위치정보 갱신 리스너 등록",
